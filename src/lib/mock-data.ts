...
export const FINDINGS = [
  {
    id: "DE-7821",
    title: "Blind SQL Injection in /api/v1/search",
    endpoint: "POST /api/v1/search?q=",
    severity: "Critical",
  ...
  {
    id: "DE-7825",
    title: "GraphQL introspection enabled in prod",
  ...
  {
    id: "DE-7828",
    title: "WebSocket message origin not validated",
    endpoint: "wss://api.target.io/live",
    severity: "Medium",
    module: "WebSocket Hijacking",
    cwe: "CWE-345",
    confidence: 82,
    ai: "Grok",
  },
  {
    id: "DE-7829",
    title: "Open redirect in /logout?next=",
    endpoint: "GET /logout",
    severity: "Low",
  ...
  {
    id: "DE-7830",
    title: "Server fingerprint leaks framework version",
    endpoint: "Response headers",
    severity: "Info",
    module: "API Security (REST)",
    cwe: "CWE-200",
    confidence: 100,
    ai: "GPT-5",
  },
  {
    id: "DE-7831",
    title: "Weak TLS cipher suite (3DES)",
    endpoint: "TLS handshake",
    severity: "Medium",
    module: "TLS Downgrade",
    cwe: "CWE-326",
    confidence: 95,
    ai: "Claude",
  },
  {
    id: "DE-7832",
    title: "Subdomain takeover candidate (S3)",
    endpoint: "old.target.io",
    severity: "High",
...
export const RECENT_SCANS = [
  ...
  {
    id: "SCN-9910",
    target: "https://dash.northwind.io",
    started: "3 h ago",
    findings: 8,
    status: "complete",
    progress: 100,
  ...
  {
    id: "SCN-9909",
    target: "https://gateway.atlas.cloud",
    started: "yesterday",
    findings: 41,
    status: "complete",
    progress: 100,
  ...
  {
    id: "SCN-9908",
    target: "https://payments.helix.app",
    started: "2 d ago",
    findings: 5,
    status: "failed",
    progress: 38,
