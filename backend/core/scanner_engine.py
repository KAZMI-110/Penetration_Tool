...
class ScannerEngine:
    ...
    def crawl_recursive(self) -> Set[str]:
        ...
        console.print("[bold blue][CRAWL] Starting web crawler...[/bold blue]")
        ...
        console.print(f"[green][OK][/green] Crawling complete. Found {len(all_urls)} URLs\n")
        return all_urls
    ...
    def scan_all_urls(self, urls: Set[str], recon_data: Optional[Dict] = None):
        ...
        console.print("[bold blue][SCAN] Starting vulnerability scanning...[/bold blue]")
        ...
        console.print(f"[green][OK][/green] Vulnerability scanning complete. Found {len(self.vulnerabilities)} issues\n")
    ...
    def run_reconnaissance(self) -> Dict:
        ...
        console.print("[green][OK][/green] Reconnaissance complete\n")
